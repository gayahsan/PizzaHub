...
<body>
	...
	<div class="container h-100">
		...
		<center>
			<button style="background-color: #4CAF50; /* Green */ border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px;" onclick="myFunction2()">PLACE MORE ORDER</button>
		</center>
		<br>
